<template>
  <div id="map">
    <b-container fluid class="p-0">
      ...
      <b-button variant="primary" class="primary"><router-link class="text-light" to="/">Сохранить</router-link></b-button>
    </b-container>
  </div>
</template>
  ...
  methods: {
    ...
    createRoute() {
      ...
      let routingParameters = {
        ...
        'destination': `${this.userPosition.lat + 0.07},${this.userPosition.lng + 0.08}`,
